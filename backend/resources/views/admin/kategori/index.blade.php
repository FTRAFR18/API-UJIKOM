    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200">
        <div class="p-5 border-b border-gray-200 bg-gray-50 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                ...
                class="bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-4 py-2 rounded-lg transition whitespace-nowrap">+ Tambah Kategori</a> 
            </div>
        </div>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="py-3 px-4 border-b">
                                <div class="flex items-center space-x-2">
                                    ...
                                    @method('DELETE')
                                    <button type="submit"
                                    class="bg-red-500 hover:bg-red-600 text-white px-3 py-1.5 rounded text-xs font-semibold transition">Hapus</button>
                                    </form>
                                </div>
                            </td>
                        </tr>
