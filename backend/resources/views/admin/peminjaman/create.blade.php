...
@section('content')
    <div class="max-w-2xl bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <form action="{{ route('admin.peminjaman.store') }}" method="POST">
            ...
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-semibold mb-2">Pilih Peminjaman (User)</label>
            ...
            <div class="mb-6">
                ...
                <button type="button" onclick="addRow()" class="mt-3 bg-gray-800 hover:bg-gray-900 text-white text-xs font-semibold px-3 py-2 rounded-lg transition">+ Tambah Alat Lain</button>
            </div>
